...
export const theme3 = $state({
	...
	subtopics: [
		...
		title_am: 'የጽድቅን ጥሩር',
		    devotional: {
		        devotional_en: './articles/themes/The Full Armor of God/Breastplate of Righteousness/devotional_en',
		        devotional_author_en: [team.AkinahomGetahun],
		        devotional_am: './articles/themes/The Full Armor of God/Breastplate of Righteousness/devotional_am',
		        devotional_author_am: [team.RebiraTibebu]
		    },
		    study_material: {
		        study_material_en: './articles/themes/The Full Armor of God/Breastplate of Righteousness/study_material_en',
		        study_material_author_en: [team.BethelemMelese],
		        study_material_am: './articles/themes/The Full Armor of God/Breastplate of Righteousness/study_material_am',
